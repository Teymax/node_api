<template>
  <div class="inventory-reports-page yard-audit container">
    <div class="page-top-line">
      <h2 class="page-header-text">Inventory Reports</h2>
      <div class="buttons-top-container">
        <button to="/" @click="$router.push('/sold-in-yard')" class="btn-choose-page btn-default btn-left" type="button">
          LSY Report
        </button>
        
        <button to="/" @click="$router.push('')" class="btn-choose-page btn-default btn-right btn-active" type="button">
          Yard Audit Report
        </button>
      </div>
    </div>
